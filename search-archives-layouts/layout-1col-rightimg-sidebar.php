							...
							<div class="postcontent">
								<?php
										if ( has_post_thumbnail( $post->ID ) ) {
											...
											echo '<div class="img thumbright">';
											echo get_the_post_thumbnail( $post->ID, 'blog-style23-image' ); 
											echo '</div>';
										}
										else {
											$postcalign_class="";
									...
									?>
								<div class="<?php echo $postcalign_class; ?> fright">
									...
									<div class="readmore simplebutton blue">										<a href="<?php the_permalink(); ?>"><?php _e( 'Read More', 'premium-code' ); ?></a></div>
